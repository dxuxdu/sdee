...
function Unparser:unparse(ast)
	...
	local Prometheus = {
		description =
		"This file was generated by Prometheus, a Lua obfuscator that provides a wide range of features to protect your code.",
	...
	local customHeader = Prometheus:createHeader()
